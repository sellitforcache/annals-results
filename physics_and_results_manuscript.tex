...
\hline
NVIDIA 270m                &    xxx   &xxx&  xxx        &  xxx                 \\
\hline
NVIDIA Tesla k20         &    xxx     &xxx&  4.8  GB      &  2.6 GHz                  \\
\hline
NVIDIA Titan Black       &     xxx   &xxx&  6.14 GB        & 3.5 GHz              \\
\hline
\hline
\hline
...
\hline
NVIDIA 270m                &     \multicolumn{2}{r|}{xxx}   &       &  $2^{32}-1$           \\
\hline
...
Cells & Isotopes (Atm \%)& Densities \\
\hline
\multirow{3}{*}{631 cylinder, r=1.0cm }  &   $^{238}$U   (0.90) &    \multirow{3}{*}{10 g/cm$^3$} \\
&  $^{235}$U (0.10)& \\
&  $^{16}$O  (2.00)& \\
\hline
