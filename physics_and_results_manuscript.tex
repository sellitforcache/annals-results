...
% This is a good thought. You might want to break this into two paragraphs and expand the second one to include a few more ideas. You might also discuss if there are places that a conventional code could do parts of the calculation with warp, or warp-like algorithms...
