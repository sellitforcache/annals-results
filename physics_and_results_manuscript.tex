...
\hline
HP Z230 Workstation     &    2044    & 95 &  8 GB         &  1.333 GHz                      \\
\hline
PSSC xxx                      &    xxx   & 460 &  96 GB        &  1.6 GHz                    \\
\hline
NVIDIA 650m                &    800   & 45 &  1 GB        &  2.5 GHz                 \\
\hline
NVIDIA Tesla k20         &    3125     & 225 &  4.8  GB      &  2.6 GHz                  \\
\hline
NVIDIA Titan Black       &     1321   & 250 &  6.14 GB        & 3.5 GHz              \\
\hline
\hline
\hline
...
\hline
PSSC xxx                      &   \multicolumn{2}{r|}{4x AMD Opteron 6172 }  &  2.1 GHz     &  48           \\
\hline
...
\hline
\multirow{4}{*}{1 sphere, r=5.1cm }  &   $^{239}$Pu   (0.90) &    \multirow{4}{*}{15.73 g/cm$^3$} \\
&  $^{240}$Pu (0.10)& \\
&  $^{69}$Ga  (0.10)& \\
&  $^{71}$Ga (0.10) & \\ 
\hline
...
This criticality test consists of a single sphere of homogenized UO$_2$ and C surrounded by molten FLiBe salt at 600 K.  The outer cell is right hexagonal prism with specular reflective boundary conditions.  Reflective boundary conditions approximates an infinite lattice of fuel spheres or a very large volumes of spheres like that in a molten salt reactor. This test introduces more isotopes, uses temperatures other than 275.3 K, and tests the reflective boundary condition setting.  
...
This test approximates a deuterium-tritium fusion reactor by simulating a 14.1 MeV neutron point source inside three concentric spheres of lithium, silicon carbide, and stainless steel.  This is a fixed source problem without multiplying materials and serves to illustrate the predefined, fixed source capabilities of WARP.  
...
Cells & Isotopes (Atm \%)& Densities \\
\hline
1 sphere, r=1 cm &  void & 0 g/cm$^3$ \\
\hline
\multirow{2}{*}{1 sphere, r=1.0cm }  &   $^{6}$Li   (0.075) &    \multirow{3}{*}{0.534 g/cm$^3$} \\
&  $^{7}$Li (0.925)& \\
\hline
\multirow{5}{*}{1 sphere, r=1.0cm }  &   $^{12}$C   (.989) &    \multirow{3}{*}{3.21 g/cm$^3$} \\
&  $^{13}$C (0.011)& \\
&  $^{28}$Si (0.9223)& \\
&  $^{29}$Si (0.0467)& \\
&  $^{30}$Si (0.0310)& \\
\hline
\multirow{1}{*}{1 sphere, r=1.2cm }  &   Identical to steel in test 4  &    \multirow{1}{*}{7.99 g/cm$^3$} \\
\hline
\end{tabular}
\end{table}
...
This test approximates a neutron guide.  It consists of a neutron plane source with a thermal spectrum emitting neutrons into a rectangular copper tube. This tube has a section of UO$_2$ followed by light water inside of it to act as a ``fission multiplier''  to produce epithermal neutrons at the exit of the guide.  This is a fixed source problem with multiplying materials and serves to illustrate the ability of WARP to calculate spectra in subcritical systems with external neutron sources.
...
Cells & Isotopes (Atm \%)& Densities \\
\hline
1 box, r=1 cm &  void & 0 g/cm$^3$ \\
\hline
\multirow{2}{*}{1 box, r=1.0cm }  &   $^{238}$U   (0.97) &    \multirow{2}{*}{19.1 g/cm$^3$} \\
&  $^{235}$U (0.03)& \\
\hline
\multirow{2}{*}{1 box, r=1.2cm }  &   $^{63}$Cu   (0.6915) &    \multirow{2}{*}{8.96 g/cm$^3$} \\
&  $^{64}$Cu  (0.3085)& \\
\hline
\multirow{2}{*}{1 box, r=1.2cm }  &   $^{1}$H   (0.6915) &    \multirow{2}{*}{1 g/cm$^3$} \\
&  $^{16}$O  (0.3085)& \\
\hline
\end{tabular}
\end{table}
