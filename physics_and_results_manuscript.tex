...
WARP currently also only has a handful of the most common ENDF sampling laws implemented.   These are laws 2, 3, 44,and XXX \cite{MCNP}.  Some nuclei require the remaining laws (), and therefore problems containing any such nuclides cannot be solved.
...
no importance, variance reduction
