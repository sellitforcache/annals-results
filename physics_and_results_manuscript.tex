...
\multirow{5}{*}{1 cylinder, r=1.2cm }  &   $^{90}$Zr   (0.5145) &    \multirow{5}{*}{6.52 g/cm$^3$} \\
                                       ...
                                       &   $^{96}$Zr   (0.0280)& \\
\hline
\multirow{2}{*}{1 box, r=1.0cm }  &    $^{2}$H   (2.0) &    \multirow{2}{*}{1.11 g/cm$^3$} \\
                                  &   $^{16}$O   (1.0) & \\
\hline
\end{tabular}
\end{table}
